...
# --- Parameters ---
target_appliance = "car1"  #Configure Target appliance
window_size = 599
threshold = 0.05  # kW
min_on_duration = 3
...
# --- Baseline Features: center aggregate + hour + dayofweek ---
...
print("🔧 Generating baseline features (Pecan St)...")
...
# --- Train AutoGluon ---
print("🚀 Training AutoGluon (Baseline)...")
...
results_df.to_csv(f"{target_appliance}_baseline_predictions_pecanstreet_1mil_1hr_AG.csv", index=False)
