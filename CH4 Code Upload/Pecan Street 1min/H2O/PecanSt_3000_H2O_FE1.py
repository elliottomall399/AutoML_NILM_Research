...
Aggregate is used as GRID (inc solar and negative behaviour)
...
results_df.to_csv(f"{target_appliance}_pecanstreet_H2O_predictions.csv", index=False)
...
def send_email_notification(): #Function to email upon completion of script. Remove or Fill with your own credentials
    from_email = ""
    to_email = ""  #
    subject = "Script Completed ✅"
    body = f"Your Python script for '{target_appliance}' H2O FE1 has finished running."
