...
os.environ["JAVA_HOME"] = r"C:\Program Files\Java\jdk-24"  # Update if your JDK version/folder differs
...
# --- Init H2O ---
#h2o.init(max_mem_size="1G", nthreads=8)
h2o.init()
...
aml = H2OAutoML(max_runtime_secs=60*60, stopping_metric="MAE", seed=42, nfolds=0)  # prevent look-ahead CV)
...
results_df.to_csv(f"{target_appliance}_predictions_1hr_1mil_NoSample_Feat1_H2O.csv", index=False)
print("csv saved!")
