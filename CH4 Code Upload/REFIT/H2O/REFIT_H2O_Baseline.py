...
# --- Baseline Level 2 Feature Engineering ---
...
aml.train(
    x=df_train.columns.drop(target_appliance).tolist(),
    y=target_appliance,
...
results_df.to_csv(f"{target_appliance}_baseline_lvl2_predictions_1mil_1hr_H2O.csv", index=False)
print("csv saved!")
